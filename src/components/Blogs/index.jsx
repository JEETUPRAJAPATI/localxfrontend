    ...
    <>
      ...
      <div className="blogList">
        <Container className="blogcnt">
          ...
          <div className="blog_header mt-3">
            {ReactHtmlParser(pageHeading_DATA || "Articles")}
            <div className="category-list">
              {blogCategories_DATA.length > 0 &&
                blogCategories_DATA.map((cat) => (
                  <span key={cat.id} className="category-Dating">
                    <Link
...
BlogList.propTypes = {
  ...
  blogCategories_DATA: PropTypes.array,
...
const mapStateToProps = (state) => ({
  ...
  blogCategories_DATA: state?.page?.blogCategories || [],
