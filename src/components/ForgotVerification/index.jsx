...
import { authForgotVerificationSendVerificationCodeAPI } from "@/api/apiService.js";
import { ErrorMessage, Formik } from "formik";

import { forgotVerificationFormSchema } from "@/utils/yupValidationSchema.js";
...
const ForgotVerification = () => {
  ...
  const forgotVerificationFormInitialValues = {
    username: "",
  };
  ...
  //:========================================
  const handleForgotVerificationSubmit = useCallback(
    (values, { setSubmitting, resetForm }) => {
      const sanitizedValues = sanitizeFields(values);

      authForgotVerificationSendVerificationCodeAPI(sanitizedValues)
  ...
  return (
    <>
      <div className="forgot-verification-code-wrapper">
        <Container className="frgt-vrfc-code-cnt">
          <Row>
          ...
          <Row>
            <Col>
              <Formik
                initialValues={forgotVerificationFormInitialValues}
                validationSchema={forgotVerificationFormSchema}
                onSubmit={handleForgotVerificationSubmit} // Formik submission handler
              >
                {({
                  handleSubmit,
                  handleChange,
...
ForgotVerification.propTypes = {};

export default memo(ForgotVerification);
